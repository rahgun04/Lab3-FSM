...
VL_ATTR_COLD void Vfsm___024root___settle__TOP__0(Vfsm___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vfsm__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfsm___024root___settle__TOP__0\n"); );
    // Body
...
VL_ATTR_COLD void Vfsm___024root___eval_settle(Vfsm___024root* vlSelf) {
    ...
    // Body
    Vfsm___024root___settle__TOP__0(vlSelf);
}

VL_ATTR_COLD void Vfsm___024root___final(Vfsm___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vfsm__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
